...
describe('Booking form', () => {
  ...
  test('All fields should render with default values', async () => {
    render(
  ...
  test('Can submit with default values', () => {
    render(
      <BookingForm availableTimes={availableTimes} submitData={submitData} />
    );
  ...
  test(
    `Empty date field should cause error`, () => {
    render(
      <BookingForm 
  ...
  test(
    `Display error when 0 people in party`, () => {
    render(
      <BookingForm 
        availableTimes={availableTimes} 
        dispatchOnDateChange={dispatchOnDateChange} 
